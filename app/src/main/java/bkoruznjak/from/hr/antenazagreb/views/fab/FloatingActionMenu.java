...
import bkoruznjak.from.hr.antenazagreb.views.fab.anim.DefaultAnimationHandler;
import bkoruznjak.from.hr.antenazagreb.views.fab.anim.MenuAnimationHandler;
...
public class FloatingActionMenu {
    ...
    public FloatingActionMenu(final View mainActionView,
        ...
        this.mainActionView.setOnLongClickListener(new ActionViewLongClickListener());
