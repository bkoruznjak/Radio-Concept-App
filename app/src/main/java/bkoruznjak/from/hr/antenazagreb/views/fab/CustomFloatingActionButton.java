package bkoruznjak.from.hr.antenazagreb.views.fab;

/**
 * Created by bkoruznjak on 10/10/2016.
 */
...
public class CustomFloatingActionButton extends FrameLayout {
     ...
     * @param contentParams
     */
    public CustomFloatingActionButton(Context context, ViewGroup.LayoutParams layoutParams, int theme,
...
//            else
            backgroundDrawable = context.getResources().getDrawable(R.drawable.button_action_orange_selector);
        }
    ...
    /**
     * A builder for {@link CustomFloatingActionButton} in conventional Java Builder format
     */
    public static class Builder {
        ...
        public Builder(Context context) {
            ...
            setTheme(CustomFloatingActionButton.THEME_LIGHT);
            setPosition(CustomFloatingActionButton.POSITION_BOTTOM_RIGHT);
        ...
        public static WindowManager.LayoutParams getDefaultSystemWindowParams(Context context) {
            ...
            WindowManager.LayoutParams params = new WindowManager.LayoutParams(
                    size,
                    size,
                    WindowManager.LayoutParams.LAST_SUB_WINDOW, // z-ordering
        ...
        public CustomFloatingActionButton build() {
            return new CustomFloatingActionButton(context,
                    layoutParams,
                    theme,
                    backgroundDrawable,
                    position,
